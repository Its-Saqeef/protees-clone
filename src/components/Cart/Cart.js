...
function Cart({setOpenCart}) {
  ...
  return (
    <section className='w-[100%] h-[100vh] top-0 left-0 absolute z-20 flex'>
        <div className='w-[10%] sm:w-[55%] lg:w-[60%] xl:w-[70%] bg-opacity-50 bg-gray-300 backdrop-blur-sm' ></div>
      <div className={`w-[100%] sm:w-[55%] md:w-[50%] lg:w-[40%] xl:w-[40%] 2xl:w-[30%] overflow-y-auto bg-white` }>
          <div className='w-[93%] mx-auto'>
              <div className='flex justify-between items-center border-b-2 py-5'>
                <h2 className='text-2xl xl:text-3xl py-2 font-semibold '>CART</h2>
              ...
              <div className={`flex flex-col justify-center`}>
               ...
               <button className='bg-black text-white p-4 font-semibold tracking-wider w-full' >CHECK OUT</button>
              </div>
